...
#   7. primary-icon.sh replaces the default home-screen icon.
#   8. app-label.sh sets the home-screen label to "Spotifyy".
#
...
color "6/8  ipapatch LC-inject zxPluginsInject"
