#!/usr/bin/env bash
# Build SpotifyySwiftProtobuf.framework — apple/swift-protobuf compiled with
# module-name `SpotifyySwiftProtobuf` so its @objc class names don't collide
# with the SwiftProtobuf statically embedded in SpotifyShared.framework.
#
# Outputs a fat (arm64+arm64e) framework at:
#   $THEOS/lib/iphone/$THEOS_PACKAGE_SCHEME/SpotifyySwiftProtobuf.framework
#
...
<dict>
    ...
    <key>CFBundleIdentifier</key><string>com.spotifyy.swiftprotobuf</string>
