...
class UIWindowKeyHook: ClassHook<UIWindow> {
    ...
    func becomeKeyWindow() {
        ...
        let lastShownVersion = UserDefaults.standard.string(forKey: "Spotifyy_LastBannerVersion")
        let currentVersion = Spotifyy.version
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 3.0) {
            ...
            UserDefaults.standard.set(currentVersion, forKey: "Spotifyy_LastBannerVersion")
        }
    }
}
