...
struct ContributorRow: View {
    let contributor: SpotifyyContributor
...
struct SpotifyyContributorsSheetView: View {
    @State private var sections: [SpotifyyContributorSection] = []
    ...
    private func loadContributors() {
        Task {
            do {
                sections = try await GitHubHelper.shared.getSpotifyyContributorSections()
            } catch {
