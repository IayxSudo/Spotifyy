struct SpotifyyContributorRole: Decodable, Equatable {
    var name: String
...
struct SpotifyyContributor: Decodable, Equatable {
    var usernames: [String]
    var displayName: String?
    var roles: [String]
    var richRoles: [SpotifyyContributorRole]?
    ...
    init(from decoder: Decoder) throws {
        ...
        richRoles = try container.decodeIfPresent([SpotifyyContributorRole].self, forKey: .richRoles)
    }
}
