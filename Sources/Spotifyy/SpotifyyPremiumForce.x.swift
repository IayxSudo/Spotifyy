...
class CoreProductStateHook: ClassHook<NSObject> {
    typealias Group = SpotifyyPremiumForceGroup
...
struct SpotifyyPremiumForceGroup: HookGroup {}
...
func activateSpotifyyPremiumForce() {
    ...
    SpotifyyPremiumForceGroup().activate()
}
