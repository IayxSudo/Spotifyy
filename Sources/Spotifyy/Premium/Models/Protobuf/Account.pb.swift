...
import Foundation
import SpotifyySwiftProtobuf

// If the compiler emits an error on this type, it is because this file
// was generated by a version of the `protoc` Swift plug-in that is
// incompatible with the version of SpotifyySwiftProtobuf to which you are linking.
// Please ensure that you are building against the same version of the API
// that was used to generate this file.
fileprivate struct _GeneratedWithProtocGenSwiftVersion: SpotifyySwiftProtobuf.ProtobufAPIVersionCheck {
  struct _2: SpotifyySwiftProtobuf.ProtobufAPIVersion_2 {}
  typealias Version = _2
}

struct SpotifyError {
  // SpotifyySwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SpotifyySwiftProtobuf library for
  ...
  var unknownFields = SpotifyySwiftProtobuf.UnknownStorage()
...
// MARK: - Code below here is support for the SpotifyySwiftProtobuf runtime.

extension SpotifyError: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "SpotifyError"
  static let _protobuf_nameMap: SpotifyySwiftProtobuf._NameMap = [
    1: .same(proto: "errorCode"),
    2: .same(proto: "errorMessage"),
  ]

  mutating func decodeMessage<D: SpotifyySwiftProtobuf.Decoder>(decoder: inout D) throws {
  ...
  func traverse<V: SpotifyySwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.errorCode != 0 {
...
extension CustomizeMessage: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension UcsResponse: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension ResolveResponse: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension ResolveConfiguration: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension AssignedValue: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension AssignedIdentifier: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension AssignedMetadata: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension BoolValue: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension IntValue: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension EnumValue: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension AccountAttributesResponse: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SpotifyySwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeMapField(fieldType: SpotifyySwiftProtobuf._ProtobufMessageMap<SpotifyySwiftProtobuf.ProtobufString,AccountAttribute>.self, value: &self.accountAttributes) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SpotifyySwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.accountAttributes.isEmpty {
      try visitor.visitMapField(fieldType: SpotifyySwiftProtobuf._ProtobufMessageMap<SpotifyySwiftProtobuf.ProtobufString,AccountAttribute>.self, value: self.accountAttributes, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension AccountAttribute: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension BootstrapMessage: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension CustomizationMessageWrapper: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
...
extension CustomizationMessageOneMoreWrapper: SpotifyySwiftProtobuf.Message, SpotifyySwiftProtobuf._MessageImplementationBase, SpotifyySwiftProtobuf._ProtoNameProviding {
