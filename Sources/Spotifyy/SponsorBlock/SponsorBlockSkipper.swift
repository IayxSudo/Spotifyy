...
final class SponsorBlockSkipper {
    ...
    private let queue = DispatchQueue(label: "com.spotifyy.sponsorblock.skipper")
    ...
    static let segmentsChangedNotification = Notification.Name("SpotifyySponsorBlockSegmentsChanged")
    ...
    private func seek(player: AnyObject, toSeconds seconds: Double) {
        ...
        SpotifyySBInvokeSeekDouble(player, sel, argDouble)
    }
