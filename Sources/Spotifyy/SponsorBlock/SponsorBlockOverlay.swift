...
private let overlayTag = "SpotifyySBOverlay"
private let segmentBarTag = "SpotifyySBBar"
...
final class SponsorBlockOverlay: NSObject, UIGestureRecognizerDelegate {
    ...
    private func segmentUUIDForTouch(_ touch: UITouch, on slider: UIView) -> String? {
        ...
        for sv in slider.subviews where sv.accessibilityIdentifier == "SpotifyySBOverlay" {
